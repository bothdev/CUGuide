...
public class EventsActivity extends AppCompatActivity {
    ...
    private EventsActivity.ArticleAdapter articleAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rclEvents = (RecyclerView)findViewById(R.id.rcl_events);
        rclEvents.setLayoutManager(new LinearLayoutManager(this));

        articleAdapter = new EventsActivity.ArticleAdapter();
    ...
    private void loadArticlesFromServer(){
        ...
        StringRequest articlesRequest = new StringRequest(url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                App.getInstance(EventsActivity.this).setArticles(articles);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(EventsActivity.this, "Error while loading articles from server", Toast.LENGTH_LONG).show();
        ...
        public ArticleViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(EventsActivity.this, ArticleDetailActivity.class);
    ...
    class ArticleAdapter extends RecyclerView.Adapter<EventsActivity.ArticleViewHolder> {
        ...
        @Override
        public EventsActivity.ArticleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(EventsActivity.this).inflate(R.layout.viewholder_article, parent, false);
            EventsActivity.ArticleViewHolder articleViewHolder = new EventsActivity.ArticleViewHolder(view);
            return articleViewHolder;
        }

        @Override
        public void onBindViewHolder(EventsActivity.ArticleViewHolder holder, int position) {
            ...
            ImageLoader imageLoader = App.getInstance(EventsActivity.this).getImageLoader();
